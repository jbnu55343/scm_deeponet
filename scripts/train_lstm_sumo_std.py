...
class LSTMModel(nn.Module):
    ...
    def forward(self, x):
        ...
        # LSTM
        output, (hn, cn) = self.lstm(src) # (B, 13, hidden_dim)
...
def main():
    ...
    parser.add_argument('--save', default='models/lstm_sumo_std.pth')
    args = parser.parse_args()
    
    logger = StdLogger("LSTM", "SUMO")
    ...
    model = LSTMModel(input_dim=11, hidden_dim=64, num_layers=2).to(device)
